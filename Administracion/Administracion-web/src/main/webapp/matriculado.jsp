							...
							<table class="table table-hover">
                               ...
                               <c:forEach items="${matriculados }" var="matriculado">
                                    <tr>
                                        ...
                                        <a class="btn btn-danger btn-xs" data-toggle="modal tooltip" data-placement="left" title="Eliminar Matriculado" href="#"> <span class="glyphicon glyphicon-trash"></span></a></td>
                                    </tr>
